<div class="inscriptions index">
	...
	<tr>
		...
		<td><?php echo h($inscription['Inscription']['nome']); ?>&nbsp;</td>
		<td><?php echo h($inscription['Inscription']['email']); ?>&nbsp;</td>
		<td><?php echo h($inscription['Inscription']['telefone']); ?>&nbsp;</td>
		<td><?php echo h($inscription['Inscription']['endereco']); ?>&nbsp;</td>
		<td><?php echo h($inscription['Inscription']['created']); ?>&nbsp;</td>
		<td><?php echo h($inscription['Inscription']['updated']); ?>&nbsp;</td>
		<td class="actions">
